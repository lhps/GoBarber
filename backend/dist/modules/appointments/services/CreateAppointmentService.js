...
let CreateAppointmentService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute({
    ...
    const dateFormatted = (0, _dateFns.format)(appointmentDate, "dd/MM/yyyy 'às' HH:mm'h'"); // const appointmentDateFormatted = format(appointmentDate, "dd 'de' MMMM 'às' HH:mm'h'");
    ...
    //   recipient_id: provider_id,
    //   content: `Novo agendamento com ${user_id}  dia ${appointmentDateFormatted}`,
    // });
